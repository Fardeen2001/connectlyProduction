    ...
    <>
      {posts && (
        <div className="flex flex-col gap-5 py-5">
          {posts.map((p) => (
            <div key={p._id} className="bg-white shadow-lg w-[700px] h-auto rounded-xl p-5">
              <div className="head flex gap-3">
                <div>
                  {console.log(p)}
                  <Image className="w-14 h-14" src={Story} alt="" />
                </div>
                <div className="flex items-center justify-between w-full">
                  <div className="flex flex-col ">
                    <h1 className="font-medium">{p.user.name}</h1>
                    <p className="text-xs text-[#656565]">{p.createdAt}</p>
                  </div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex gap-5 items-center">
                  <p className="text-[#656565]">{p.likes} likes</p>
              ...
              <div className="flex justify-between items-center">
                <div className="flex gap-5 items-center">
                  ...
                  >
                    <Image width={22} src={comment} alt="comment icon" /> Comment
                  </p>
                </div>
              ...
              <div className="flex items-center gap-3">
                <div>
                  <Image src={Story} className="rounded-full w-12 h-12" alt="user story"/>
                </div>
