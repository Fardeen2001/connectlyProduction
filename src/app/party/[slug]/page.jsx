          ...
          <div className="bg-white shadow-lg rounded-2xl h-[18rem]">
            ...
            <div className="flex items-center h-[10rem]">
              <Image
                alt="connectly"
                src={Pic}
                className="w-32 h-32 relative left-5 bottom-10 rounded-full"
              />
            ...
            <div className="bg-white h-fit w-full px-4 py-2 rounded-lg">
              ...
              <div className="flex flex-col gap-2">
                <div className="bg-[#F1F1F1] w-full p-2 rounded">
                  <Image alt="connectly" src={post_img} className="rounded" />

                  <div>
                    <div className="my-2">
                      <h3 className="text-sm">Tuesday Sunset</h3>
                      <p className="text-xs">
                        Do you want this event to occur?
                      </p>
                    </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-white shadow-lg w-full px-3 py-5 rounded-lg ">
              ...
              <p className="flex items-center gap-2 text-black  my-2">
                ...
                consectetur adipisicing elit. Commodi dignissimos possimus
                obcaecati voluptatibus rerum consequuntur blanditiis harum
                incidunt neque ea!
              </p>
            </div>
                ...
                <>
                  ...
                  <div className="flex flex-col gap-5 mt-5">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <button className="px-3 py-2 border border-[#F45044] text-[#F45044] rounded">
                          {" "}
                          Share
                        </button>
                      </div>
