      ...
      <div>
        ...
        <div className="flex flex-col gap-4 my-4">
          ...
          <div className="flex flex-col gap-2 my-2">
            <div className="flex items-center gap-2">
              <Image alt="connectly" src={post2} className="w-12 h-12" />

              <h3>Ralph Edwards</h3>
              <span className="bg-[#67C23A33] text-[#67C23A] p-1 text-xs">
                Admin
              </span>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3>Ralph Edwards</h3>
                <span className="bg-[#FBB04080] text-[#FBB040] p-1 text-xs">
                  Moderator
                </span>
              </div>
        ...
        <div className="flex flex-col gap-4 my-4">
          ...
          <div className="flex flex-col gap-2 my-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button className="px-3 py-2 border border-[#F45044] text-[#F45044] flex items-center gap-1 rounded">
                  Message
                </button>
