      ...
      <div className="flex flex-col gap-5 py-2">
        ...
        <div className="bg-white w-[760px] h-auto rounded-xl px-5 py-2">
          ...
          <div className="head flex gap-3">
            <div>
              <Image alt="connectly" className="w-14 h-14" src={post} />
            </div>
          ...
          <div className="flex justify-between items-center">
            <div className="flex gap-5 items-center">
              <p onClick={handleLike} className="flex items-center gap-2">
                <Image alt="connectly" width={22} src={heart_fill} /> Like
              </p>
        ...
        <div className="bg-white w-[760px] h-auto rounded-xl px-5 py-2">
          ...
          <div className="head flex gap-3">
            <div>
              <Image alt="connectly" className="w-14 h-14" src={post3} />
            </div>
          ...
          <div className="my-10 border">
            <div>
              <Image alt="connectly" src={post_img2} />
            </div>
        ...
        <div className="bg-white w-[760px] h-auto rounded-xl px-5 py-2">
          ...
          <div className="head flex gap-3">
            <div>
              <Image alt="connectly" className="w-14 h-14" src={post4} />
            </div>
          ...
          <div className="my-2">
            ...
            <div>
              <Image alt="connectly" src={post_img4} />
            </div>
          </div>
        ...
        <div className="bg-white w-[760px] h-auto rounded-xl px-5 py-2">
          ...
          <div className="head flex gap-3">
            <div>
              <Image alt="connectly" className="w-14 h-14" src={post5} />
            </div>
        ...
        {/* Vote Cards */}
        {/* <div className='bg-white w-[700px] h-auto rounded-xl px-5 py-2'>
                <div className='flex items-center border-b-2 gap-2 mb-3 py-2'>
                        <div>
                            <Image alt="connectly" className='w-8 h-8 rounded-full' src={Story} alt='' />
                        </div>
                        <div className='flex items-center gap-1'>
                            <h1 className='text-sm'>Alexandro Vargas</h1>
                            <p className='text-xs text-black '>you liked this post</p>
                    ...
                    <div className="head flex gap-3">
                        <div>
                            <Image alt="connectly" className='w-14 h-14' src={post6} alt='' />
                        </div>
                    ...
                    <div className='my-10 flex items-center justify-center gap-3 whitespace-nowrap overflow-x-auto overflow-y-hidden h-[400px] relative'>
                        <div className=' w-[20rem] h-[10rem] relative bottom-24'>
                            <div className='w-full h-full overflow-hidden'>
                                <Image alt="connectly" src={post_img} className='object-contain w-full h-full scale-[2]' />
                            </div>
