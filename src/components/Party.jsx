    ...
    <div className="shadow-lg bg-white w-full h-full px-5 py-4 rounded-lg">
      <div className="flex flex-col gap-2">
        ...
        <div className="grid grid-cols-2 gap-5 px-1 py-3">
          {events.map((event) => {
            return (
              <div key={event.id} className="border rounded-lg h-fit">
                <Image
                  alt="connectly"
                  src={event.cover_Pic}
                  className="h-[10rem]"
                ...
                <div className="px-5 flex flex-col gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col py-5">
                      ...
                      <p className="text-xs">
                        Public Hosted by{" "}
                        <span className="text-[#EF4136]">{event.hosted}</span>
                      </p>
                    </div>
                  </div>

                  <div className="flex items-center justify-between">
                    <button className="border bg-[#CCCCCC] rounded-full px-4 py-1">
                      {event.tags}
                    </button>

                    <BsThreeDotsVertical
                      size={22}
                      className="border border-[#F45044] text-[#F45044] rounded"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between my-3">
                    <Link
                      href={`/party/${event.id}`}
                      className="border border-[#F45044] rounded text-[#F45044] px-8 py-2"
                    >
                      Book Me In
                    </Link>
